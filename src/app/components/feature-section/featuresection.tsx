...
const FeaturesBanner: React.FC = () => {
    ...
    return (
        <div className="bg-[#141414] text-start flex justify-center w-full">
            <div className="w-full text-start flex justify-center container mx-auto py-8 sm:py-10  ">
                <div className="flex flex-col text-start sm:flex-row justify-center sm:justify-center items-start gap-12 sm:gap-4 md:gap-8 container mx-auto">
